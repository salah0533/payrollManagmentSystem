...
export function VacationChart({
  ...
  const chartData = [
    { status: "Available", employees: available, fill: "hsl(var(--chart-1))" },
    { status: "On leave", employees: employeesOnVacation, fill: "hsl(var(--chart-2))" },
  ];

  return (
    <Card className="overflow-hidden">
      <CardHeader>
        <CardTitle>Vacation Impact</CardTitle>
        <CardDescription>How many employees are currently away.</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="mb-5 rounded-2xl bg-accent/45 p-4">
          <div className="flex items-end justify-between gap-4">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary/70">On vacation</p>
